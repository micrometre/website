  ...
  return (
    <>
          <div className="home-wave"
            ...
            <Wave
              style={{ height: "56vh", zIndex: 5, margin: 0, transform: "rotate(180deg)", left: 0, }}
              className="wave-bg"
              fill="#00acc1"
              paused={false}
              options={{
            ...
            <div className="wave-intro"
              style={{ position: "absolute", top: "28vh", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", paddingLeft: "7%", paddingRight: "5%", width: "60%", }}>
